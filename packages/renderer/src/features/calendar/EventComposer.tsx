 ...
 *
 * Created unclassified on purpose. What an appointment *means* — its area, whether it counts
 * toward your hours, whether there is a journey either side — is the classifier's question,
 * and asking it twice in two different dialogs is how the two answers drift apart. So this
 * asks only what a calendar asks, and hands straight over.
 */
